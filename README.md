...
Я MASHINIST, Системный Администратор и Фронтенд Разработчик.
- :telescope: Я работаю в сфере Linux.
- :seedling: Изучаю NuxtJS.
- :zap: В свободное время Пишу скрипты для упрощение рутиных задач.
...
### :hammer_and_wrench: Инструменты Системного администратора:
...
<div align="center">
  ...
  <img src="https://github.com/devicons/devicon/blob/master/icons/docker/docker-original-wordmark.svg" title="Docker" alt="Linux" width="40" height="40"/>
</div>
